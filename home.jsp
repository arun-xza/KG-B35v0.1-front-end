    ...
    <body>
        ...
        <nav class="nav-bar">
            ...
            <ul class="navbar">
                ...
                <li><a href="facaltyreg.jsp"><i class="fa fa-map"></i><span>faculty Register</span> </a></li>
                                <li><a href="assign.jsp"><i class="fa fa-sliders"></i><span>Assign Subject </span></a></li>
                                <li><a href="editreg.jsp"><i class="fa fa-edit"></i><span>Edit Regiter</span></a></li>
                                <li><a href="addsub.jsp"><i class="fa fa-map"></i><span>Add Subject</span> </a></li>                               
                                <li><a href="#"><i class="fa fa-edit"></i><span>Edit Subject Detail</span></a></li>
            </ul>
        </nav>
    </body>
</html>